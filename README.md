...
# В этом обновлении
- Фикс [бага](https://cdn.discordapp.com/attachments/1041774453434101851/1095014346452648076/image.png) (пишите в консоль `pip uninstall discord.py discord discord.py-self` и запускайте батник чтоб пофиксить)

# Внимание!
Обратите внимание, что селф боты запрещены правилами площадки Discord!
